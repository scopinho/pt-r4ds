...
Artitmética modular é o termo técnico para o tipo de matemática que você fez quando aprendeu sobre casas decimais, por exemplo: divisão que retornam um valor inteiro e um resto.
...
`log2()` é fácil interpretar pois a diferença de 1 na escala logarítmica corresponde ao dobro na escalada original e a diferença de -1 corresponde à metade; e o `log10()` é de fácil transformação inversa (*back-transform*) (por exemplo: 3 é 10\^3 = 1000).
...
Ela usa o método típico para lidar com empates, por exemplo: 1o, 2o, 2o, 4o.
...
`cumsum()`, da @sec-cumulative-and-rolling-aggregates, vem pra ajudar com intervalos (*gaps*), por exemplo: `tem_intervalo_grande` como `TRUE`, irá incrementar `grupo` em um (@sec-numeric-summaries-of-logicals):
