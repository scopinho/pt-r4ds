...
-   O @sec-joins encerra esta parte do livro sobre transformação, fornecendo ferramentas para unir dois (ou mais) *data frames*.
    Entender sobre *joins* fará com que você assimile o conceito de chaves (*keys*) de banco de dados e pense sobre como identificar cada linha em um conjunto de dados.
