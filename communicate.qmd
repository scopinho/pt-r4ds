...
Até agora, você aprendeu as ferramentas para inserir seus dados no R, organizá-los em uma forma conveniente para análise para, posteriormente, entender seus dados por meio de transformação e visualização.
