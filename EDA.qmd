...
Esse capítulo mostrará a você como usar visualização e transformação para explorar seus dados em uma forma sistemática, uma terfa que os estatísticos chamam de análise exploratória dos dados, ou EDA (Exploratory Data Analysis) abreviamente.
