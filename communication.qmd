...
#| message: false
#| fig-alt: |
#|   Gráfico de dispersão de consumo em rodovias versus cilindrada dos carros, onde
...
ggplot(milhas, aes(x = cilindrada, y = rodovia)) +
  ...
  labs(
    ...
    y = "Consumo de combustível na rodovia (mpg)",
...
2. Recrie o gráfico a seguir usando os dados de economia de combustível.
    ...
    #| echo: false
    #| fig-alt: |
    #|   Gráfico de dispersão de consumo de combustível em rodovias versus em cidades. Formas e
...
```{r}
#| fig-alt: |
#|   Gráfico de dispersão de consumo na rodovia versus cilindrada onde os pontos são coloridos
#|   por tração. Curvas suaves para cada tipo de tração são sobrepostas. 
...
```{r}
#| fig-alt: |
#|   Gráfico de dispersão do consumo nas rodovias versus cilindradas, onde 
...
```{r}
#| fig-alt: |
#|   Gráfico de dispersão do consumo nas rodovias versus as cilindradas dos carros. Pontos
...
```{r}
#| fig-alt: |
#|   Gráfico de dispersão do consumo nas rodovias versus cilindradas dos carros. Uma seta
...
```{r}
#| fig-alt: |
#|   Gráfico de dispersão de consumo nas rodovias versus cilindradas dos carros, colorido
...
```{r}
#| fig-alt: |
#|   Gráfico de dispersão de consumo nas rodovias versus cilindrada dos carros
