...
#| fig-width: 4
#| fig-alt: |
#|   À esquerda, um gráfico de dispersão de eficiência de combustível 
#|   nas rodovias versus cilindradas de SUVs.
...
#|   entre eficiência e cilindrada nas rodovias enquanto
#|   que no gráfico de carros compactos 
...
O ggplot2 inclui os oito temas mostrados na @fig-themes, com `theme_gray()` como padrão.[^communication-1]
...
[^communication-1]: Muitas pessoas se perguntam por que o tema padrão tem um fundo cinza.
