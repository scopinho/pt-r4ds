...
Normalmente, isso significa que você esqueceu de adicionar um `"` ou um `)`. Adicione o par que está faltando ou pressione ESCAPE (ou ESC) para abortar a expressão e tentar novamente.
