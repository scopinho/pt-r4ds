...
Você agora tem alguma experiência em executar código R.
...
Antes de irmos mais longe, vamos garantir que você tenha uma base sólida na execução de código R e que conheça alguns dos recursos mais úteis do RStudio.
...
Todos os comandos R em que você cria objetos, **comandos de atribuição**, têm a mesma forma:
...
## A importância dos nomes {#sec-whats-in-a-name} <!-- Não consegui pensar numa tradução melhor para esse subtítulo, sugestões sao bem-vindas. -->
