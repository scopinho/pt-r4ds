...
Inserir os dados por coluna pode dificultar a visualização de como as linhas estão relacionadas, então uma alternativa é `tribble()`, abreviação de _**tr**ansposed t**ibble**_ (tibble transposta), que permite organizar seus dados linha por linha.
