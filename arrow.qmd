...
Next capítulo, você aprenderá uma alternativa poderosa: o formato [parquet](https://parquet.apache.org/), um formato baseado em um padrão aberto largamente utilizado em sistemas de grande volume de dados (*big data*).
...
Usaremos *Apache Arrow* via o [pacote arrow](https://arrow.apache.org/docs/r/), o qual fornece um *backend* dplyr permitindo que você analise conjuntos de dados maiores que a quantidade de memória de seu computador usando a sintaxe dplyr familiar.
...
Geralmente, é dificil saber qual funcionará melhor, então para fases iniciais da tua análise, nós encorajamos você a tentar os dois e escolher um que melhor funcione para você.
...
3.  Como as retiradas de livros vs livros eletrônicos (*ebooks*) mudou ao longo dos últimos 10 anos?
