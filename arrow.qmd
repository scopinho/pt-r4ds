...
Neste capítulo, continuaremos a usar tydiverse, particularmente dplyr, mas iremos combiná-lo com o pacote *arrow*, que foi projetado especificamente para trabalhar com grandes conjuntos de dados.
...
-   Arquivos *parquet* são normalmente menores que seus arquivos equivalentes CSV.
    *Parquet* é baseado em [codificação eficiente](https://parquet.apache.org/docs/file-format/data-pages/encodings/) para manter o tamanho do arquivo menor e suporta compressão de arquivo.
