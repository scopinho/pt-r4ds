...
#|   voos (2.000-7.000) no eixo y. O padrão é bastante constante entre
...
Não é exatamente 1, porque `dyears()` é definido como o número de segundos pela duração média de um ano, que é 365,25 dias.
