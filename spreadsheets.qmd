...
1.  Em um arquivo do Excel, crie o seguinte conjunto de dados e salve como `pesquisa.xlsx`.
    Alternativamente, você pode baixar [aqui](https://docs.google.com/spreadsheets/d/1yc5gL-a2OOBr8M7B3IsDNX5uR17vBHOyWZq6xSTG2G8) como arquivo do Excel.
...
2.  Em outro arquivo do Excel, crie o seguinte conjunto de dados e salve como `lista.xlsx`.
    Alternativamente, você pode baixar [aqui](https://docs.google.com/spreadsheets/d/1LgZ0Bkg9d_NK8uTdP2uHXm07kAlwx8-Ictf8NocebIE) como arquivo do Excel.
    ...
    O conjunto de dados resultante deve ser nomeado como `lista` e deve se parecer como a seguir.
...
3.  Em um novo arquivo do Excel, crie o seguinte conjunto de dados e salve como `vendas.xlsx`.
    Alternativamente, você pode baixar [aqui](https://docs.google.com/spreadsheets/d/1oCqdXUNO8JR3Pca8fHfiz_WXWxMuZAp3YiYFaKze5V0) como arquivo do Excel.
    ...
    O conjunto de dados deve se parecer como a seguir, com `id` e `n` como nomes das colunas e com 9 linhas.
