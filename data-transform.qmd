...
Nós voltaremos para essa assunto na parte de Transformações do livro, onde cada capítulo vai te mostrar as ferramentas para cada tipo específico de variáveis.
...
No próximo capítulo, voltaremos ao fluxo de trabalho para discutir sobre a importância do estilo de código, para manter seu código bem organizado para facilitar para você e outros lerem e entenderem. 
