...
Essa base contém todos os `r format(nrow(dados::voos), big.mark = ".", decimal.mark = ",")` vôos que saíram da cidade de Nova Iorque em 2013.
...
3.  Como os atrasos variam ao longo do dia.
