...
Preste bastante atenção às mensages de conflito exibidas quando você carregar o tidyverse. 
...
[^NT-1]: de _double precision floating number_ - remete à forma como números reais são representados nos computados, utilizando 64 bits em vez dos tradicionais 32 bits de um inteiro comum, por isso "double" (dobro).
