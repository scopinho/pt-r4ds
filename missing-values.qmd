...
Começaremos discutindo algumas ferramentas gerais para trabalhar com valores faltantes registrados como `NA`s.
...
Funciona como a `select()`, pegando um conjunto de colunas como argumento:
