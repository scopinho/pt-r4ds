...
knitr::include_graphics("images/tidy-1-pt.png", dpi = 270)
```
...
Para resolver esse problema, novamente precisamos passar um vetor para `names_to`, mas dessa vamos vamos passar um parâmetro especial `".value"` (chamado de *sentinel*); esse parâmetro não é o nome de uma variável, mas um valor único que diz ao `pivot_longer()` para fazer algo diferente com ele.
...
## Transformando os dados para o formato largo
