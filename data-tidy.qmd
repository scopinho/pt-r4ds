...
2.  A maioria das pessoas não está familiarizada com os princípios do formato e é difícil derivá-lo espontaneamente a menos que já se tenha trabalhado com dados por muito tempo.
...
O conjunto de dados `billboard` marca a posição das músicas na billboard no ano 2000:
...
Por enquanto, nós utilizaremos `measure_cd` como a fonte de nossa nova coluna de nomes, mas em uma análise real você deveria considerar seu próprio nome de variável, que deve ser curto e informativo.
