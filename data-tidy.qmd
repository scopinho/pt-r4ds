...
Agora voltaremos nossa atenção ao _data frame_ resultante, em um formato mais longo.
...
Não é possível dizer apenas com esses dados, mas você poderia imaginar que colunas adicionais `semana77`, `semana78`, ... seriam incluídas no conjunto de dados.
...
Vamos criar os dados com `tribble()`, uma função útil para construir pequenos conjuntos de dados (_tibbles_) manualmente:
