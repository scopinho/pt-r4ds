...
> "Todos os conjuntos de dados organizados se parecem, cada conjunto de dados desorganizados são desorganizados à sua maneira."\
> --- Hadley Wickham
...
>> Uma vez que você tenha em mãos os dados no formato _tidy_ e as ferramentas do tidyverse, você irá gastar muito menos tempo alternando seus dados de uma reprensetação para outra, de forma que ele possa ser gasto nas perguntas que você realmente se importa.
...
>> Pivotar lhe permite mudar a forma de seus dados sem modificar nenhum de seus valores.
