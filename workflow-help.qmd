...
[^workflow-help-1]: **Nota de tradução**: São dados que estão sempre disponíveis no R (por exemplo: mtcars), e são bastante utilizados em exemplos, aulas, tutoriais, entre outros.
